...
int main()
{
    ...
    cin>>t;
    while(t--){
        bign num,num1,num2,num3;
        cin>>num;
        num1=(num-1)*num/2;
        bool isok1=false,isok2=false;
        num2=num.Sqrt();num3=num1.Sqrt();
        if(num2*num2==num)isok1=true;
        if(num3*num3==num1)isok2=true;
        if(isok1&&isok2){
            cout<<"Arena of Valor"<<'\n';
        }
        else if(isok1&&!isok2){
