...
public class Tax_table {
	private static double getXTax(int income) {
	...
	private static double getY_1Tax(int income) {
	...
	private static double getY_2Tax(int income) {
	...
	private static double getZTax(int income) {
